    ...
    <div class="row">
      <div class="col-lg-12 mb-5 mb-lg-0">
        ...
        <div class="contact-form">
          <form action="{{ url('cektransaksi') }}" type="POST" id="fruitkha-contact" onSubmit="return valid_datas( this );">
            <center><p>
                <input type="text" placeholder="Input Kode Transaksi" name="tokenkode" id="tokenkode">
              @error('tokenkode')
