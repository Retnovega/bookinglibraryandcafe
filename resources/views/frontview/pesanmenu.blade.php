...
<div class="product-section mt-150 mb-150">
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12 text-center"><a href="{{ url('listpesan/'.$meja->kodeqr) }}" class="cart-btn" style="width:100%"><i class="fas fa-shopping-cart"></i> Selesaikan Pemesanan</a></div>

      <div class="col-lg-6 text-center"></div><div class="col-lg-6 text-center"></div>
    ...
    @else
    <center><h3>Maaf Meja Tidak Terdaftar</h3></center>
    @endif
...
<div class="modal fade" id="modal{{ $menu->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ url('addpesan') }}" type="POST" id="fruitkha-contact" onSubmit="return valid_datas( this );">
