          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Tambah Data Resensi</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('resensi.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="penulis" name="penulis" value="{{ old('penulis') }}" placeholder="Input Penulis">
                    @error('penulis')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
