...
<head>
	...
	<!-- title -->
	<title>Website Booking</title>

	<!-- favicon -->
	<link rel="shortcut icon" type="image/png" href="{{ url('theme/assets/img/favicon.png') }}">
	<!-- google font -->
...
<body>
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a href="about.html">About</a>
									<ul class="sub-menu">
										<li><a href="about-booking.html">About Book.ing</a></li>
								...
								<li><a href="monolog.html">Monolog</a>
									<ul class="sub-menu">
										<li><a href="resensi.html">Resensi</a></li>
								...
								<li><a href="dialog.html">Dialog</a>
									<ul class="sub-menu">
										<li><a href="kajian.html">Kajian</a></li>
										<li><a href="agenda.html">Agenda</a></li>
									</ul>
								</li>
								<li><a href="lapak.html">Lapak</a>
								</li>
								<li>
	...
	<div class="copyright">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p>Copyrights 2019 - <a href="#">Retno Vega Astuti</p>
				</div>
